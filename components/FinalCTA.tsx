  ...
  return (
    <section className="final-cta-section">
      <div className="cta-content">
        <h2 className="cta-title">Il professionista giusto quando ne hai bisogno</h2>
        ...
        <div className="download-buttons">
          <a
            ...
            data-analytics-id="cta-final-ios"
          >
            ...
            <div className="button-text">
              <span className="button-text-small">Download on the</span>
          ...
          <a
            ...
            data-analytics-id="cta-final-android"
          >
            <div className="button-icon">
